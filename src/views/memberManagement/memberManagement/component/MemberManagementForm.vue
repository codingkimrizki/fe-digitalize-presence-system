<template>
  <a-form layout="vertical" :model="formData" :rules="formRules" @finish="handleSubmit">
    <!-- Machine Number Field -->
    <!-- <a-form-item label="Machine Number" name="id" :validate-trigger="['blur', 'change']">
      <a-input-number
        :controls="false"
        :min="1"
    ...
    <!-- Brand Field -->
    <a-form-item label="New Member Name" name="brand" :validate-trigger="['blur', 'change']">
      <a-input placeholder="Enter Brand" v-model:value="formData.brand" :disabled="isDeleteMode" />
    </a-form-item>

    <!-- Machine Number Field -->
    <a-form-item label="NIK" name="id" :validate-trigger="['blur', 'change']">
      <a-input-number
        :controls="false"
        :min="1"
        placeholder="Enter Machine Number"
    ...
    <a-form-item label="Department" name="brand" :validate-trigger="['blur', 'change']">
      <a-select>
        <a-select-option value="jack">PE</a-select-option>
        <a-select-option value="lucy">AL</a-select-option>
        <a-select-option value="disabled" disabled>QC</a-select-option>
        <a-select-option value="Yiminghe">PM</a-select-option>
        </a-select>
    </a-form-item>
    ...
    <!-- Tonnage Field -->
    <!-- <a-form-item label="Tonnage" name="tonnage" :validate-trigger="['blur', 'change']">
      <a-input-number
